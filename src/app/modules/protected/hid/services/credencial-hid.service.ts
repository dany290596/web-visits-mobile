...
import { ICredencialHIDFilter, ICredencialHIDRequest } from '../../../protected/hid/interfaces/credencial-hid.interface';
...
export class CredencialHIDService {
    ...
    createWallet(request: ICredencialHIDRequest): Observable<any> {
        return this.http.post(`${url}CredencialHID/CreateWalletCredential`, request, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    inactivate(id: string) {
        return this.http.patch(`${url}CredencialHID/Inactivate/${id}`, null, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    reactivate(id: string) {
        return this.http.patch(`${url}CredencialHID/Reactivate/${id}`, null, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    suspend(id: string) {
        return this.http.patch(`${url}CredencialHID/Suspend/${id}`, null, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
