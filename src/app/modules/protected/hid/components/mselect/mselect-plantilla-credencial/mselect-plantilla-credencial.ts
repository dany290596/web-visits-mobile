...
@Component({
  selector: 'app-mselect-plantilla-credencial',
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  template: `
    ...
    ></p-multiSelect>
  `,
  styleUrl: './mselect-plantilla-credencial.css',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => MselectPlantillaCredencial),
    multi: true
  }]
})
export class MselectPlantillaCredencial implements OnInit, ControlValueAccessor {
  items: any[] = [];
