...
@Component({
  ...
  template: `
    <label class="form-label">Plataforma <span class="text-red-500" *ngIf="isRequired">*</span></label>
    <p-autoComplete
  ...
  `,
  styleUrl: './autoc-plataforma.css',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => AutocPlataforma),
    multi: true
  }]
})
export class AutocPlataforma implements OnInit, ControlValueAccessor {
  items: any[] = [];
  filteredItems: any[] = [];
