...
export class AgregarEmpresa implements OnInit {
  ...
  //     tipos: ['742CE98B-684B-4A76-BA0D-CF62621FC3E7', 'BB617929-5F49-4FDC-8C28-62435505B600', '29625587-4A45-495A-B728-203608694C44']
  //   },
  //   {
  //     key: 'urlConfig', label: 'Configuración de URLS',
  //     tipos: ['60ADEBFE-01B5-497A-828B-CF3801F37495', '9B02E35B-A069-4BF5-B9CA-337A59455347', '82481E61-4BF5-44CE-B222-3283F7BC02F9', '84BA81E1-56C0-4BEE-A57F-D05C13BB544A']
  //   },
  //   {
  //     key: 'apiParams', label: 'Parámetros de API',
  //     tipos: ['40E1A0B9-9144-490E-BF75-7663F3447118', '4B6BCEFA-20CA-48B9-92FA-5396C7C94202', '788F90F3-0CE3-4E96-B4BA-38DA1CFE105B', 'FF5E7D45-FCED-4169-B4EB-BA70B43F7BB6']
  //   },
  //   {
  ...
  //     tipos: ['D539FF01-17F0-4C29-9E17-668A5591ACE5', '18A0E41D-960E-4F52-9604-D0C773A87F9C', '32DC2E87-E6A4-48D7-AF0E-B967ED2BBF49']
  //   },
  // ];
  ...
  //     telefonoMovil: ['', [Validators.required, Validators.minLength(3)]],
  ...
  //     this.messageService.add({ severity: 'success', summary: 'Conexión exitosa', detail: 'Prueba de conexión HID completada' });
  //   }, 2000);
  // }
  ...
  //     this.messageService.add({ severity: 'warn', summary: 'Atención', detail: 'Debe probar la conexión HID antes de guardar' });
  //     return;
  //   }
