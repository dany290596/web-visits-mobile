...
export class PlantillaNotificacionService {
    ...
    getAll(filter: IPlantillaNotificacionFilter): Observable<any> {
        ...
        return this.http.get(`${url}PlantillaNotificacion`, opciones).pipe(
            catchError((e: any) =>
                of(e)
            ),
    ...
    getById(id: string) {
        return this.http.get(`${url}PlantillaNotificacion/${id}`, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    create(request: IPlantillaNotificacionRequest): Observable<any> {
        return this.http.post(`${url}PlantillaNotificacion`, request, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    update(request: IPlantillaNotificacionRequest, id: string): Observable<any> {
        return this.http.put(`${url}PlantillaNotificacion?id=${id}`, request, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    inactivate(id: string) {
        return this.http.patch(`${url}PlantillaNotificacion/Inactivate?id=${id}`, null, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
    ...
    reactivate(id: string) {
        return this.http.patch(`${url}PlantillaNotificacion/Reactivate?id=${id}`, null, {
            headers: new HttpHeaders(
                {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`,
