...
import { ICiudadFilter, ICiudadRequest } from '../interfaces/ciudad.interface';
...
export class CiudadService {
    ...
    getAll(filter: ICiudadFilter): Observable<any> {
    ...
    create(request: ICiudadRequest): Observable<any> {
    ...
    update(request: ICiudadRequest, id: string): Observable<any> {
