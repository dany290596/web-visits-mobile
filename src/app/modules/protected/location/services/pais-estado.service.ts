...
import { IPaisEstadoFilter, IPaisEstadoRequest } from '../interfaces/pais-estado.interface';
...
export class PaisEstadoService {
    constructor(
        private http: HttpClient
    ) { }

    getAll(filter: IPaisEstadoFilter): Observable<any> {
    ...
    create(request: IPaisEstadoRequest): Observable<any> {
    ...
    update(request: IPaisEstadoRequest, id: string): Observable<any> {
