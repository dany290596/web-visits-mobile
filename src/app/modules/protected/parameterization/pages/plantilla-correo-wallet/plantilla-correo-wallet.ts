...
export class PlantillaCorreoWallet implements OnInit, OnDestroy {
  ...
  idSection: string = "EE221E04-DAF8-4BEA-9909-6C3A26861763";
  ...
  showEmailOAuth(): void {
    ...
    // forkJoin({
    //   tenant: this.srvConfiguracion.updateConfiguracionGeneral(this.tenantData.id, tenantRequest),
    //   client: this.srvConfiguracion.updateConfiguracionGeneral(this.clientData.id, clientRequest),
    //   clientSecret: this.srvConfiguracion.updateConfiguracionGeneral(this.clientSecretData.id, clientSecretRequest),
    //   email: this.srvConfiguracion.updateConfiguracionGeneral(this.emailData.id, emailRequest),
    //   protocolo: this.srvConfiguracion.updateConfiguracionGeneral(this.protocoloEnvioCorreoData.id, protocolRequest)
    // }).subscribe({
    //   next: (responses) => {
    //     if (responses.tenant.respuesta === true &&
  ...
  showEmailSMTP(): void {
    ...
    // forkJoin({
    //   email: this.srvConfiguracion.updateConfiguracionGeneral(this.emailSMTPData.id, emailRequest),
    //   servidor: this.srvConfiguracion.updateConfiguracionGeneral(this.servidorSMTPData.id, servidorRequest),
    //   puerto: this.srvConfiguracion.updateConfiguracionGeneral(this.puertoSMTPData.id, puertoRequest),
    //   usuario: this.srvConfiguracion.updateConfiguracionGeneral(this.usuarioSMTPData.id, usuarioRequest),
    //   contrasena: this.srvConfiguracion.updateConfiguracionGeneral(this.contrasenaSMTPData.id, contrasenaRequest),
    //   ssl: this.srvConfiguracion.updateConfiguracionGeneral(this.sslSMTPData.id, sslRequest),
    //   tls1: this.srvConfiguracion.updateConfiguracionGeneral(this.tls1SMTPData.id, tls1Request),
    //   tls2: this.srvConfiguracion.updateConfiguracionGeneral(this.tls2SMTPData.id, tls2Request),
    //   protocolo: this.srvConfiguracion.updateConfiguracionGeneral(this.protocoloEnvioCorreoData.id, protocolRequest)
    // }).subscribe({
    //   next: (responses) => {
